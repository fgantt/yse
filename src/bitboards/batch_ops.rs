    ...
    unsafe fn batch_and_avx512<const N: usize>(
        ...
        if remaining_start < N {
            ...
            if remaining >= 2 {
                ...
                result_slice[remaining_start] = SimdBitboard::from_u128(u128::from_le_bytes(r1_bytes));
                result_slice[remaining_start + 1] = SimdBitboard::from_u128(u128::from_le_bytes(r2_bytes));
            } else {
                ...
                result_slice[remaining_start] = SimdBitboard::from_u128(u128::from_le_bytes(result_bytes));
            }
        }
