...
fn bench_combine_all(c: &mut Criterion) {
    ...
    
    {
        ...
        group.bench_with_input(
            BenchmarkId::new("tree_reduction", 4),
            &4,
            |bencher, _| {
                bencher.iter(|| {
                    let arr = generate_combine_all_data::<4>();
    ...
    
    {
        ...
        group.bench_with_input(
            BenchmarkId::new("tree_reduction", 8),
            &8,
            |bencher, _| {
                bencher.iter(|| {
                    let arr = generate_combine_all_data::<8>();
    ...
    
    {
        ...
        group.bench_with_input(
            BenchmarkId::new("tree_reduction", 16),
            &16,
            |bencher, _| {
                bencher.iter(|| {
                    let arr = generate_combine_all_data::<16>();
    ...
    
    {
        ...
        group.bench_with_input(
            BenchmarkId::new("tree_reduction", 32),
            &32,
            |bencher, _| {
                bencher.iter(|| {
                    let arr = generate_combine_all_data::<32>();
    ...
    
    {
        ...
        group.bench_with_input(
            BenchmarkId::new("tree_reduction", 64),
            &64,
            |bencher, _| {
                bencher.iter(|| {
                    let arr = generate_combine_all_data::<64>();
...
fn bench_batch_vs_scalar(c: &mut Criterion) {
    ...
    // Size 8
    {
        ...
        group.bench_with_input(
            BenchmarkId::new("neon_optimized", 8),
            &8,
            |bencher, _| {
                bencher.iter(|| {
                    let (a, b) = generate_test_data::<8>();
    ...
    // Size 16
    {
        ...
        // Optimized NEON implementation
        group.bench_with_input(
            BenchmarkId::new("neon_optimized", 16),
            &16,
            |bencher, _| {
                bencher.iter(|| {
                    let (a, b) = generate_test_data::<16>();
    ...
    // Size 32
    {
        ...
        // Optimized NEON implementation
        group.bench_with_input(
            BenchmarkId::new("neon_optimized", 32),
            &32,
            |bencher, _| {
                bencher.iter(|| {
                    let (a, b) = generate_test_data::<32>();
