...
fn test_batch_filter_attacks() {
    ...
    for i in 0..4 {
        ...
        assert_eq!(filtered.get(i).to_u128(), expected.to_u128(), 
                   "Filtered attack {} should match expected", i);
    }
}
...
fn test_batch_merge_attacks() {
    ...
    for i in 0..4 {
        ...
        assert_eq!(merged.get(i).to_u128(), expected.to_u128(),
                   "Merged attack {} should match expected", i);
    }
}
...
fn test_batch_move_generation_scenario() {
    ...
    for i in 0..4 {
        ...
        assert_eq!(valid_moves.get(i).to_u128(), expected.to_u128(),
                   "Valid moves for piece {} should match expected", i);
    }
}
...
fn test_batch_operations_performance_characteristics() {
    ...
    // Verify correctness
    for i in 0..16 {
        assert_eq!(filtered.get(i).to_u128(), large_array.get(i).to_u128(),
                   "Filtered result {} should match input", i);
        assert_eq!(merged.get(i).to_u128(), mask.get(i).to_u128(),
                   "Merged result {} should match mask", i);
    }
